...
(function ($) {
    ...
    var methods = {
        ...
        'select': function (o) {
            ...
            if (selectobj.settings.multiSelect == 'Single') {
                selectobj.values.empty();
                selectobj.div.find('p').each(function () {
                    $(this).removeClass('coolmulti-selected');
                });
            }

            $('p#' + selectobj.settings._id + '_o_' + o).addClass('coolmulti-selected');
            selectobj.values.append('<p id="' + selectobj.settings._id + '_os_' + o + '" vv="' + o + '">' + text + '<a class="coolmulti-del" href="#">' + selectobj.settings.delText + '</a></p>')
